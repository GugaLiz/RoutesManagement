Ext.define('RM.HighSpeedTrain.Grid', {
    ...
    buildItems: function () {
        ...
        var store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url: RM.Url('/HighSpeedTrain/List/?type=1'),
        ...
        cols.push({
            ...
            items: [{
                ...
                handler: function (grid, rowIndex, colIndex) {
                    ...
                    var id = rec.get('Id');
                    var url = RM.Url('/HighSpeedTrain/ExportKml/' + id);
                    RM.downloadFile(url);
                }
            }]
        });
                ...
                handler: function (grid, rowIndex, colIndex) {
                    ...
                    if (rec) {
                        ...
                        if (coordinates) {
                            ...
                            me.fireEvent("edit_line", me, rec.data, jcoors);
                        }
                    }
                }
            }]
        ...
        me.dockedItems = [{
            ...
            items: [{
                ...
                handler: function () {
                    var win = me._addWin;
                    if (!win) {
                        win = Ext.create('RM.HighSpeedTrain.ImportWin', {
                            listeners: {
                    ...
                    items: [{
                        ...
                        handler: function () {
                            ...
                            if (sels.lenght > 0) {
                                ...
                                var url = RM.Url('/HighSpeedTrain/ExportKml?ids=' + ids.join(','));
                                RM.downloadFile(url);
                            }
                        }
                    }, {
